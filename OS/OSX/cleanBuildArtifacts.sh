...
usage() {
   echo
   echo -e "${DARKBLUE}Usage:${NC} ./cleanBuildArtifacts.sh                    # Removes default build artifacts"
   echo -e "${BROWN}OR${NC}"
   echo -e "${DARKBLUE}Usage:${NC} ./cleanBuildArtifacts.sh 'FileName'         # Removes specified file/folder recursively"
   echo
}
